    ...
    <body>
        ...
        <div class="container">
            <div class="mx-auto col-sm-8 main-section" id="myTab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link active" id="list-tab" data-toggle="tab" href="#list" role="tab" aria-controls="list" aria-selected="false">Shampoo</a>
                </li>
                <li class="nav-item">
                        ...
                        <div class="card-body">
                            ...
                            <table id="userList" class="table table-bordered table-hover table-striped">
                                ...
                                <tr>
                                    ...
                                    <th scope="col">Toxico o no toxico</th>
                                    <th></th>
                                </tr>
                                </thead>
                                <tbody>
...
if ($result->num_rows > 0){
    ...
    while($row = $result->fetch_assoc()){
        ...
        echo "<td>".$row["Para que sirve"]."</td>";
        echo "<td>".$row["Toxico o no toxico"]."</td>";
        echo "<td>
        <a href='index1/Page-10.html'><i class='fas fa-edit'></i></a></td>";
        echo "<td><a href='borrar.html'><i class='fas fa-user-times'></i></a>
    </td>";
    echo "</tr>";
    //echo "<br> "id:.row["id"] -Nombre: .$row["Nombre"]. -"Codigo:".$row["Codigo"]. -"Para que sirve:".$row["Para que sirve"]. -"Toxico o no toxico:" .$row["Toxico o no toxico"] . </br>;
    }
} else{
    echo "0 result";
}
