    ...
    <body>
        ...
        <div class="container">
            <div class="mx-auto col-sm-8 main-section" id="myTab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link active" id="list-tab" data-toggle="tab" href="#list" role="tab" aria-controls="list" aria-selected="false">Accesorios</a>
                </li>
                <li class="nav-item">
...
if ($result->num_rows > 0){
    ...
    echo "</tr>";
    //echo "<br> "id:.row["id"] -Nombre: .$row["Nombre"]. -"Codigo:".$row["Codigo"]. -"Cantidad:".$row["Cantidad"]. -"Color:" .$row["Color"] . </br>;
    }
} else{
    echo "0 result";
}
